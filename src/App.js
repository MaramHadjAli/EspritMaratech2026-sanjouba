...
const AppRoutes = () => {
    ...
    return (_jsx(Routes, { children: isAuthenticated ? (
        ...
        // Public routes
        _jsxs(_Fragment, { children: [_jsx(Route, { path: "/login", element: _jsx(LoginPage, {}) }), _jsx(Route, { path: "/register", element: _jsx(RegisterPage, {}) }), _jsx(Route, { path: "/", element: _jsx(LandingPage, {}) }), _jsx(Route, { path: "*", element: _jsx(NotFound, {}) })] })) }));
};
function App() {
